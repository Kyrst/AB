					...
					<td style="font-size:13px;vertical-align:top;box-shadow:0 0 8px rgba(0, 0, 0, .15)" valign="top">
						...
						<div style="margin-top:35px;text-align:left;padding:0 36px">
							<p style="color:#84949F;font-size:15px;line-height:32px;font-family:Times new roman">
								ActingBio is still in BETA (in its early stages of development), which means that as a thank you for being an early adopter, we’ve assigned you a unique ID <span style="color:#A37E2C;font-weight:bold;font-family:Arial">#<?= $code ?></span> for you to set up your account before anyone else.
								<br>
