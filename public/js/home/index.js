...
$(function()
{
	...
	{
		console.log('is_pre_register_open: ' + is_pre_register_open);
		console.log('submit_button_just_clicked: ' + submit_button_just_clicked);

		if ( is_pre_register_open || submit_button_just_clicked || $(this).is(':focus') )
		{
			return;
		}
